...
| `auth.allowedGitHubLogins` | *(empty)* | Optional comma-separated GitHub login allowlist; empty allows any OAuth user. |
| `auth.adminGitHubLogins` | *(empty)* | Optional comma-separated GitHub logins promoted or kept as admins. |
