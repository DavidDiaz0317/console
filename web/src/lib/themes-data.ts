/**
 * Theme data definitions extracted from themes.ts to reduce file size (#12209).
 * This file contains all individual theme definitions used by the theme system.
 */

import type { Theme, ThemeFont, ThemeColors } from './themes'

// Re-export types
export type { Theme, ThemeFont, ThemeColors }
