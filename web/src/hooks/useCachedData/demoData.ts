...
export const getDemoPods = (): PodInfo[] => [
  ...
  { name: 'ml-worker-8f9a6b7c3-k4lm2', namespace: 'ml-workloads', cluster: 'aks-dev-westeu', status: 'Running', ready: '1/1', restarts: 0, age: '1d', cpuRequestMillis: 4000, memoryRequestBytes: 8589934592, gpuRequest: 2, cpuUsageMillis: 3200, memoryUsageBytes: 7516192768, metricsAvailable: true },
  { name: 'inference-server-5d4c3b2a1-n7op9', namespace: 'ml-workloads', cluster: 'aks-dev-westeu', status: 'Running', ready: '1/1', restarts: 2, age: '3d', cpuRequestMillis: 2000, memoryRequestBytes: 4294967296, gpuRequest: 1, cpuUsageMillis: 1850, memoryUsageBytes: 3865470566, metricsAvailable: true },
  ...
  {
    name: 'etcd-eks-prod-us-east-1-0',
  ...
  },
  {
    ...
    age: '9d',
    labels: { component: 'etcd', 'app.kubernetes.io/name': 'etcd' },
    containers: [{ name: 'etcd', image: 'registry.k8s.io/etcd:3.5.11-0', ready: true, state: 'running' }],
  },
  {
    name: 'etcd-gke-staging-1',
    namespace: 'kube-system',
    cluster: 'gke-staging',
    status: 'Running',
    ready: '1/1',
  ...
  },
  {
    ...
    age: '11d',
    labels: { component: 'etcd', 'app.kubernetes.io/name': 'etcd' },
    containers: [{ name: 'etcd', image: 'registry.k8s.io/etcd:3.5.10-0', ready: true, state: 'running' }],
  },
  {
    name: 'etcd-aks-dev-westeu-1',
    namespace: 'kube-system',
    cluster: 'aks-dev-westeu',
    status: 'Running',
    ready: '1/1',
