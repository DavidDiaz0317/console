      ...
      {isPlaying && (
        <div className="flex flex-wrap items-center justify-between gap-2 text-xs">
          ...
          <div className="flex gap-1">
            <button
              onClick={togglePause}
              className="p-0.5 rounded bg-secondary/60 hover:bg-secondary/80 transition-colors"
              ...
              >
                ...
                >
                  ...
                  <div className={`card-face absolute inset-0 backface-hidden rotate-y-180 ${
                    card.matched ? 'bg-green-500/20 border-green-500/30' : 'bg-secondary/60 border-border'
      ...
      {isPaused && (
        <div className="absolute inset-0 bg-black/50 backdrop-blur-xs flex items-center justify-center z-10 rounded-xl">
          <div className="text-center">
            ...
            <button
              onClick={togglePause}
              className="mt-2 px-3 py-1.5 text-sm bg-secondary/60 hover:bg-secondary/80 rounded-lg transition-colors"
            >
              Resume
            </button>
          </div>
