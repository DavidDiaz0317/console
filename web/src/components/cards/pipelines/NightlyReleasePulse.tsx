...
export function NightlyReleasePulse() {
  ...
  useCardLoadingState({ isLoading: (pulseLoading || matrixLoading) && !hasData, isRefreshing: pulseRefreshing || matrixRefreshing, hasAnyData: hasData, isDemoData: isDemoMode })
