  ...
  useEffect(() => {
    ...
    if (saved) {
      try {
        ...
        showToast('Could not restore your previous game (corrupted save data). Starting a new game.', 'warning')
      }
    }
    ...
    if (savedBestTimes) {
      try {
        ...
        showToast('Could not load your best times from storage. Your previous records may not be displayed.', 'warning')
      }
    }
  }, [showToast])
