...
type HelmReleaseStatusValue = 'deployed' | 'failed' | 'pending' | 'superseded' | 'uninstalling' | 'unknown'
  ...
  const allReleases = useMemo(() => {
    return allHelmReleases.map(r => {
      ...
      return {
        ...
        status: (r.status?.toLowerCase() ?? 'unknown') as HelmReleaseStatusValue,
        updated: r.updated,
