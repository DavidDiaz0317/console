...
export function NamespaceMonitor({ config: _config }: CardComponentProps) {
  ...
  useCardLoadingState({
    isLoading,
    isRefreshing: namespacesRefreshing || deploymentsRefreshing || servicesRefreshing ||
      pvcsRefreshing || podsRefreshing || configmapsRefreshing || secretsRefreshing || jobsRefreshing,
