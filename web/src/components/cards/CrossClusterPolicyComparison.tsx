...
function CrossClusterPolicyComparisonInternal({ config: _config }: CardConfig) {
  ...
  const { statuses: kyvernoStatuses, isLoading, isRefreshing, lastRefresh, isDemoData, refetch, clustersChecked, totalClusters, consecutiveFailures, isFailed } = useKyverno()
  ...
  useCardLoadingState({ isLoading: isLoading && !isDemoData, isRefreshing, hasAnyData: true, isDemoData, isFailed, consecutiveFailures })
