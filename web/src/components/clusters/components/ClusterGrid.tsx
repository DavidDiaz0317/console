...
const LocalClusterControls = memo(function LocalClusterControls({
  ...
  return (
    <div className="flex items-center gap-0.5 min-h-11" onClick={(e) => e.stopPropagation()}>
      {isStopped ? (
        <button
          onClick={(e) => handleAction('start', e)}
          disabled={!!actionInProgress}
          className={`p-1 min-h-11 min-w-11 flex items-center justify-center rounded transition-colors ${
