      ...
      {activeTab === 'bindings' && (
        <div className="bg-card/50 border border-border rounded-xl overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody>
              {bindings.map(b => (
                <tr key={b.id} className="border-b border-border/50 hover:bg-background/80">
                  <td className="p-3">
                  ...
                  <td className="p-3">
                    <span className="px-2 py-1 bg-muted rounded text-xs text-muted-foreground">{b.kind}</span>
                  </td>
                  ...
                  <td className="p-3 text-muted-foreground font-mono text-xs">{b.role_name}</td>
                  <td className="p-3 text-muted-foreground">{b.cluster}</td>
                  <td className="p-3 text-muted-foreground">{b.namespace || '—'}</td>
                  <td className="p-3">
