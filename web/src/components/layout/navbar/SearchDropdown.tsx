    ...
    <div data-tour="search" data-testid="global-search" className="flex-1 min-w-0" ref={searchRef}>
      <div className="relative">
        ...
        <input
          ...
          className={`w-full pl-10 py-2 bg-secondary rounded-lg text-sm text-foreground placeholder:text-muted-foreground focus:outline-hidden focus:ring-2 focus:ring-purple-500/50 ${isSearchOpen ? 'pr-4' : 'pr-16'}`}
        />
        {!isSearchOpen && (
