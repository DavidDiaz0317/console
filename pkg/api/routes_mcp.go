...
// Backward-compatible routes for storage resource access (#11537, #11538)
// Shorthand routes so frontend useCachedPVCs/usePVs hooks can fetch without /mcp prefix
api.Get("/pvcs", mcpHandlers.GetPVCs)
api.Get("/pvs", mcpHandlers.GetPVs)
