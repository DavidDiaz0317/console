...
// the atomic capacity check fails — either the combined active reservation
// count is already at or above capacity, or the caller's requested gpu_count
// would push it over. Handlers should map this error to HTTP 409 Conflict.
